...
const ProfileSection = () => {
  ...
  return (
    <div className="relative w-full px-[16px] mx-auto max-w-[700px] ">
      <div className="w-[40px] h-[40px] rounded-full border border-dashed border-[#D0D5DD] flex items-center justify-center absolute right-[16px] sm:right-[80px] top-[-20px] cursor-pointer hover:bg-[#D0D5DD]"><img src="/share-icon.svg" alt="share-icon" className="hidden sm:block"/><img src="/dots-icon.svg" alt="share-icon" className="sm:hidden"/></div>
